    ...
    */
    ...
    enable(options?: {
      around?: 'center';
        ...
        this._el.classList.add('mapabcgl-touch-zoom-rotate', 'mapboxgl-touch-zoom-rotate');
    }
    ...
    disable() {
        ...
        this._el.classList.remove('mapabcgl-touch-zoom-rotate', 'mapboxgl-touch-zoom-rotate');
    }
