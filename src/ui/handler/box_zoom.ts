...
class BoxZoomHandler {
    ...
    mousemoveWindow(e: MouseEvent, point: Point) {
        ...
        if (!this._box) {
            this._box = DOM.create('div', 'mapabcgl-boxzoom mapboxgl-boxzoom', this._container);
            this._container.classList.add('mapabcgl-crosshair', 'mapboxgl-crosshair');
    ...
    reset() {
        ...
        this._container.classList.remove('mapabcgl-crosshair', 'mapboxgl-crosshair');
