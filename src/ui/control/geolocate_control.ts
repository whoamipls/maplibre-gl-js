...
class GeolocateControl extends Evented implements IControl {
    ...
    _setErrorState() {
        ...
        case 'WAITING_ACTIVE':
            ...
            this._geolocateButton.classList.remove('mapabcgl-ctrl-geolocate-active', 'mapboxgl-ctrl-geolocate-active');
            this._geolocateButton.classList.add('mapabcgl-ctrl-geolocate-active-error', 'mapboxgl-ctrl-geolocate-active-error');
            break;
        case 'ACTIVE_LOCK':
            this._watchState = 'ACTIVE_ERROR';
            this._geolocateButton.classList.remove('mapabcgl-ctrl-geolocate-active', 'mapboxgl-ctrl-geolocate-active');
            this._geolocateButton.classList.add('mapabcgl-ctrl-geolocate-active-error', 'mapboxgl-ctrl-geolocate-active-error');
            this._geolocateButton.classList.add('mapabcgl-ctrl-geolocate-waiting', 'mapboxgl-ctrl-geolocate-waiting');
            // turn marker grey
            break;
        case 'BACKGROUND':
            this._watchState = 'BACKGROUND_ERROR';
            this._geolocateButton.classList.remove('mapabcgl-ctrl-geolocate-background', 'mapboxgl-ctrl-geolocate-background');
            this._geolocateButton.classList.add('mapabcgl-ctrl-geolocate-background-error', 'mapboxgl-ctrl-geolocate-background-error');
            this._geolocateButton.classList.add('mapabcgl-ctrl-geolocate-waiting', 'mapboxgl-ctrl-geolocate-waiting');
            // turn marker grey
            break;
        case 'ACTIVE_ERROR':
    ...
    _onSuccess(position: GeolocationPosition) {
        ...
        if (this.options.trackUserLocation) {
            ...
            case 'ACTIVE_ERROR':
                ...
                this._geolocateButton.classList.remove('mapabcgl-ctrl-geolocate-waiting', 'mapboxgl-ctrl-geolocate-waiting');
                this._geolocateButton.classList.remove('mapabcgl-ctrl-geolocate-active-error', 'mapboxgl-ctrl-geolocate-active-error');
                this._geolocateButton.classList.add('mapabcgl-ctrl-geolocate-active', 'mapboxgl-ctrl-geolocate-active');
                break;
            case 'BACKGROUND':
            case 'BACKGROUND_ERROR':
                this._watchState = 'BACKGROUND';
                this._geolocateButton.classList.remove('mapabcgl-ctrl-geolocate-waiting', 'mapboxgl-ctrl-geolocate-waiting');
                this._geolocateButton.classList.remove('mapabcgl-ctrl-geolocate-background-error', 'mapboxgl-ctrl-geolocate-background-error');
                this._geolocateButton.classList.add('mapabcgl-ctrl-geolocate-background', 'mapboxgl-ctrl-geolocate-background');
                break;
            default:
                assert(false, `Unexpected watchState ${this._watchState}`);
            }
        ...
        if (this.options.showUserLocation) {
            this._dotElement.classList.remove('mapabcgl-user-location-dot-stale', 'mapboxgl-user-location-dot-stale');
        }
    ...
    _onError(error: GeolocationPositionError) {
        ...
        if (this._watchState !== 'OFF' && this.options.showUserLocation) {
            this._dotElement.classList.add('mapabcgl-user-location-dot-stale', 'mapboxgl-user-location-dot-stale');
        }
    ...
    _setupUI(supported: boolean) {
        ...
        this._geolocateButton = DOM.create('button', 'mapabcgl-ctrl-geolocate mapboxgl-ctrl-geolocate', this._container);
        DOM.create('span', 'mapabcgl-ctrl-icon mapboxgl-ctrl-icon', this._geolocateButton).setAttribute('aria-hidden', 'true');
        ...
        if (this.options.showUserLocation) {
            this._dotElement = DOM.create('div', 'mapabcgl-user-location-dot mapboxgl-user-location-dot');

            this._userLocationDotMarker = new Marker(this._dotElement);

            this._circleElement = DOM.create('div', 'mapabcgl-user-location-accuracy-circle mapboxgl-user-location-accuracy-circle');
    ...
    * var geolocate = new mapabcgl.GeolocateControl({
    *  positionOptions: {
    *    enableHighAccuracy: true
    *  },
    *  trackUserLocation: true
